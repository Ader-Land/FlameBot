...
struct BoardCoordinate {
  ...
  BoardCoordinate &
  operator=(BoardCoordinate other) // minor bugfix; btw whole namecpace need a
                                   // bugfix & optimisation
  {
...
public:
  ...
  BoardCoordinate setCoordinate(Chess::BoardCoordinate nw) {
...
// Görsel Düzen: [File][Rank] -> Sol taraf 1. Rank (White), Sağ taraf 8. Rank
// (Black)
const std::array<std::array<Square, 9>, 9> defaultBoardMatris = {
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::A, Rank::Eight), Piece::Rook,
               Side::Black)},
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::B, Rank::Eight), Piece::Knight,
               Side::Black)},
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::C, Rank::Eight), Piece::Bishop,
               Side::Black)},
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::D, Rank::Eight), Piece::Queen,
               Side::Black)},
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::E, Rank::Eight), Piece::King,
               Side::Black)},
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::F, Rank::Eight), Piece::Bishop,
               Side::Black)},
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::G, Rank::Eight), Piece::Knight,
               Side::Black)},
    ...
    std::array<Square, 9>{
        ...
        Square(BoardCoordinate(File::H, Rank::Eight), Piece::Rook,
               Side::Black)}};
...
public:
  ...
  bool isCastled(Side side) const {
    return (side == Side::White) ? whiteCastled : blackCastled;
  }
  bool setCastled(Side side, bool b) {
    return ((side == Side::White) ? whiteCastled : blackCastled) = b;
  }

  bool isKingMoved(Side side) const {
    return (side == Side::White) ? whiteKingMoved : blackKingMoved;
  }
  bool isKingRookMoved(Side side) const {
    return (side == Side::White) ? whiteKingRookMoved : blackKingRookMoved;
  }
  bool isQueenRookMoved(Side side) const {
    return (side == Side::White) ? whiteQueenRookMoved : blackQueenRookMoved;
  }

  bool setKingMoved(Side side, bool b) {
    return ((side == Side::White) ? whiteKingMoved : blackKingMoved) = b;
  }
  bool setKingRookMoved(Side side, bool b) {
    return ((side == Side::White) ? whiteKingRookMoved : blackKingRookMoved) =
               b;
  }
  bool setQueenRookMoved(Side side, bool b) {
    return ((side == Side::White) ? whiteQueenRookMoved : blackQueenRookMoved) =
               b;
  }
  ...
  Side passTurn() {
    return turn = (turn == Side::White ? Side::Black : Side::White);
  }
